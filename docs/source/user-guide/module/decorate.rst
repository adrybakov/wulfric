...
.. doctest::
    ...
    >>> from wulfric import plot_hlines, plot_vlines # doctest: +SKIP
...
.. doctest::
    ...
    >>> from wulfric import custom_cmap # doctest: +SKIP
...
.. doctest::
    ...
    >>> from wulfric import oneline
    >>> print(oneline()) # doctest: +SKIP
    on 9 August 2023 at 16:50:17 by wulfric 0.8.0
    >>> print(oneline(doclink=True)) # doctest: +SKIP
    on 9 August 2023 at 16:51:0 by wulfric 0.8.0 Documentation: wulfric.org
