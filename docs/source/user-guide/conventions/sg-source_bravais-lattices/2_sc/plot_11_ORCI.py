...
Body-centered orthorhombic cell is defined by three parameters :math:`a`, :math:`b` and :math:`c` with :math:`a < b < c`.
...
To get an example of the cell use :py:func:`wulfric.cell.SC_ORCI`.
