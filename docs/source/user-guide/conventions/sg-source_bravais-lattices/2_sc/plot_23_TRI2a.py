...
TRI lattice has variation TRI2a when :math:`k_{\alpha} > 90^{\circ}, k_{\beta} > 90^{\circ}, k_{\gamma} = 90^{\circ}`.
...
# sphinx_gallery_thumbnail_path = 'img/gallery-thumbnails/bl-sc/TRI2a.png'
