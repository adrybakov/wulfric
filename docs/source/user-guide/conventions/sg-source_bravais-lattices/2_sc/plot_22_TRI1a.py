...
TRI lattice has variation TRI1a when :math:`k_{\alpha} > 90^{\circ}, k_{\beta} > 90^{\circ}, k_{\gamma} > 90^{\circ}` and :math:`k_{\gamma} = \min(k_{\alpha}, k_{\beta}, k_{\gamma})`.
...
cell = wulfric.cell.sc_get_example("TRI1a")
...
# sphinx_gallery_thumbnail_path = 'img/gallery-thumbnails/bl-sc/TRI1a.png'
