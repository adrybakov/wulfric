...
RHL lattice has variation RHL1 if :math:`\alpha < 90^{\circ}`.
...
cell = wulfric.cell.sc_get_example_cell("RHL1")
...
# sphinx_gallery_thumbnail_path = 'img/gallery-thumbnails/bl-sc/RHL1.png'
